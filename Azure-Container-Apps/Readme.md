...
- ❌ Add new env variable: Update 4 places in template + 1 in parameters
- ❌ Change RG/Subscription: Update 4+ places in template + multiple in parameters
- ❌ Error-prone and time-consuming

**After (Automated Approach):**
- ✅ Add new env variable: Update **1 line** in `variable.json`
- ✅ Change RG/Subscription: Update **1 section** in `variable.json`
- ✅ Run script → Done!
...
├── backend-sales
│   ├── backend_variable.json
│   ├── template.json          (generated)
│   └── parameters.json        (generated)
└── sales_ui
    ├── sales_ui_variable.json
    ├── template.json          (generated)
    └── parameters.json        (generated)
```
...
```
backend-sales/
├── backend_variable.json   (your config)
├── template.json             (generated by script)
└── parameters.json           (generated by script)
```
...
📦 Deploying: backend-sales
📄 Config: backend-sales/backend_variable.json

✅ Resource group validated: sales-sol-web-2

🔧 Generating templates...
✓ Generated backend-sales/template.json
✓ Generated backend-sales/parameters.json

✅ Templates generated:
   📄 backend-sales/template.json
   📄 backend-sales/parameters.json
...
✅ Successfully deployed: backend-sales
```
